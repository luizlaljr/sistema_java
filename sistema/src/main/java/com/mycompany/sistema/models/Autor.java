...
public class Autor implements Serializable {
    ...
    public Autor(Long id, Integer ordem, String email, String primeiroNome, String meioNome, String sobreNome, String afiliacao, String afiliacaoIngles, String pais, String orcId, Artigo artigo) {
        this.id = id;
        this.ordem = ordem;
        this.email = email;
