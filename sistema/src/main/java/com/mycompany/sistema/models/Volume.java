...
public class Volume implements Serializable {
    ...
    private SortedList<Artigo> artigos;

    public Volume() {
    }

    public Volume(Long id, String evento, Integer edicaoEvento, String cidadeEvento, String dataEvento, String descricaoPortugues, String descricaoIngles, SortedList<Artigo> artigos) {
        this.id = id;
        this.evento = evento;
    ...
    public SortedList<Artigo> getArtigos() {
        return artigos;
    }

    public void setArtigos(SortedList<Artigo> artigos) {
        this.artigos = artigos;
    }
